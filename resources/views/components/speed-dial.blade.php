<div data-dial-init class="fixed right-6 bottom-6 group">
    ...
    <button type="button" data-dial-toggle="speed-dial-menu-default" aria-controls="speed-dial-menu-default"
        aria-expanded="false"
        class="flex items-center justify-center text-white bg-[#27AE60] rounded-full w-14 h-14 hover:bg-[#21C437] dark:bg-blue-600 dark:hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 focus:outline-none dark:focus:ring-blue-800">
