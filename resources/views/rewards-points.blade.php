<x-app-layout>
    <div class="container mx-auto">
        <h1 class="text-xl font-medium font-serif p-4">Meus pontos</h1>


        <div
            class="mt-5 p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <a href="#">
                <h5 class="mb-2 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">Pontos recebidos até
                    hoje: <span class="text-primary-800"> {{ $rewardPoints }} </span></h5>
            </a>
            <p class="mb-3 font-normal text-gray-500 dark:text-gray-400">Clique no passo a
                passo sobre como certificar seus benefícios semanais:</p>
            <a href="#" class="inline-flex items-center text-blue-600 hover:underline">
                Veja os requisitos dos seus pontos
        ...
        @if (isset($rewards) && !empty($rewards))
            <!-- Start block -->
            <section class="mt-5 p-3 sm:p-5 antialiased">
                        ...
                        <div
                            ...
                            <div class="w-full md:w-1/2">
                                <form class="flex items-center">
                                    <label for="simple-search" class="sr-only">Pesquise</label>
                            ...
                            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                <thead
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" class="px-4 py-3">m²</th>
                                        <th scope="col" class="px-4 py-3">Endereço</th>
                                        <th scope="col" class="px-4 py-3">Pontos</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr class="border-b dark:border-gray-700">
                                        <th scope="row"
                                            ...
                                            {{$reward->propertie->titulo}}</th>
                                        <td class="px-4 py-3">{{$reward->propertie->tipo}}</td>
                                        <td class="px-4 py-3">{{$reward->propertie->metros_quadrados}}</td>
                                        <td class="px-4 py-3 max-w-[12rem] truncate">{{$reward->propertie->endereco}}</td>
                                        <td class="px-4 py-3">{{$reward->points}}</td>
                    ...
                    <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                        ...
                        <dl>
                            ...
                            <dd class="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400">Standard glass ,3.8GHz
                                8-core 10th-generation Intel Core i7 processor, Turbo Boost up to 5.0GHz, 16GB 2666MHz
                                DDR4
                                memory, Radeon Pro 5500 XT with 8GB of GDDR6 memory, 256GB SSD storage, Gigabit
                                Ethernet,
